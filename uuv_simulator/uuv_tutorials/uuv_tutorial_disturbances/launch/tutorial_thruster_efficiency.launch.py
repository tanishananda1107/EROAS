...
def generate_launch_description():
    ...
    # Include set_thruster_output_efficiency.launch (thruster_id=2)
    thruster_efficiency_2 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('uuv_control_utils'),
                'launch',
    ...
    # Include set_thruster_output_efficiency.launch (thruster_id=6)
    thruster_efficiency_6 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('uuv_control_utils'),
                'launch',
    ...
    return LaunchDescription([
        ...
        controller,
        circular_trajectory,
        thruster_efficiency_2,
        thruster_efficiency_6,
        rviz
    ])
