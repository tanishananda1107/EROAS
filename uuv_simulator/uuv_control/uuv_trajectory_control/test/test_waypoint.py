...
class TestWaypoint(unittest.TestCase):
    ...
    def test_violate_constraint_flag(self):
        ...
        self.assertTrue(wp.violates_constraint, 'Constraint violation flag [K
not correctly set')
    ...
    def test_distance_calculation(self):
        ...
        node = Node('test_node')
        publisher = node.create_publisher(Waypoint, 'waypoints', 10)

        self.assertEqual(wp.dist([0, 4, 0]), 2, 'Distance calculation is wr[2D[K
wrong')
    ...
    def test_to_message(self):
        ...
        self.assertEqual(wp0, wp1, "Waypoint to message conversion failed")[8D[K
failed")
