#!/usr/bin/env python3
"""
Launch file for ocean waves underwater world simulation.
This world model simulates underwater environment with wave effects.
"""
...
def launch_setup(context, *args, **kwargs):
    """Set up the launch configuration for ocean waves world."""
    ...
    if set_timeout == 'true':
        actions.append(IncludeLaunchDescription(
            ...
            condition=IfCondition(condition=paused),
        ))
